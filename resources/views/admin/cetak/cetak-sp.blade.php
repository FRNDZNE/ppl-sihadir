...
<body>
    ...
    <table border="0" style="width: 100%;">
        <tbody>
            <tr>
                <td width="93">No</td>
                <td width="8">:</td>
                <td width="250">730/PL16.A3/EP/{{ \Carbon\Carbon::now()->year }}</td>
                <td></td>
            </tr>
            <tr>
                <td>Lampiran</td>
            ...
            <tr>
                <td>Perihal</td>
                <td>:</td>
                <td style="font-weight: bold; text-decoration: underline;">{{ $spName }}</td>
                <td></td>
            </tr>
            <tr>
                <td>Kepada</td>
                <td>:</td>
                <td>Yth. <span style="font-weight: bold;">Sdr. {{ $mahasiswa->user->name }}</span></td>
                <td valign="top">
                    <div align="right" style="font-weight: bold;">NIM. {{ $mahasiswa->nim }}</div>
                </td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td><span style="font-weight: bold">Kelas {{ $mahasiswa->semester->name }}
                        {{ $mahasiswa->kelas->name }}</span></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
    ...
    <p>
        Oleh karena itu, berdasarkan Buku Peraturan Direktur tentang Penyelenggaraan Pendidikan
        Politeknik Negeri Pontianak {{ $pasal }}, Saudara dinyatakan telah mendapatkan
        {{ $spName }}.
    </p>

    @if ($spLevel !== 'Drop Out')
        <p>
            Bilamana jumlah ketidakhadiran Saudara mencapai batas berikutnya, maka akan
            diberikan surat peringatan berikutnya sesuai ketentuan yang berlaku.
        </p>
    @else
        <p>
            Berdasarkan ketentuan tersebut, Saudara dinyatakan <strong>Diberhentikan (Drop Out)</strong>
            dari Politeknik Negeri Pontianak.
        </p>
    @endif
