                                    ...
                                    <form action="{{ route('admin.week.store') }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="minggu" class="form-control"
                                                    placeholder="Masukkan Minggu" aria-describedby="helpId">
                                            </div>
                                            <div class="form-group">
                            ...
                            <tbody>
                                @foreach ($week as $w)
                                    <tr>
                                        ...
                                        <td>{{ $w->name }}</td>
                                        <td>{{ $w->start_date ?? 'Belum Ditentukan' }}</td>
                                        <td>{{ $w->end_date ?? 'Belum Ditentukan' }}</td>
                                        <td>
                                            <!-- Button trigger modal -->
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modaledit-{{ $w->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('admin.week.update') }}" method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="minggu">Minggu</label>
                                                                    <input type="text" name="name" id="minggu"
                                                                        value="{{ $w->name }}" class="form-control"
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modaldelete-{{ $w->id }}">
                                                <i class="fas fa-trash"></i>
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="modaldelete-{{ $w->id }}" tabindex="-1"
                                                role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">Batal</button>
                                                            <form action="{{ route('admin.week.delete', $w->id) }}"
                                                                method="post">
                                                                @csrf
                                                                <button type="submit"
